...
module.exports = class RTCSession extends EventEmitter {
        ...
        // Audio and/or video requested, prompt getUserMedia.
          ...
          return navigator.mediaDevices
            ...
            .catch((error) => {
              ...
              console.error('emit "getusermediafailed" [error:%o]', error);
      ...
      .then(() => {
        ...
        this._connectionPromiseQueue = this._connectionPromiseQueue
          ...
          .catch((error) => {
            ...
            console.error(
              'emit "peerconnection:setremotedescriptionfailed answer" [error:%o]',
              error
            );
          ...
          if (this._late_sdp) {
            ...
            this._connectionPromiseQueue = this._connectionPromiseQueue
              ...
              .catch((error) => {
                ...
                console.error(
                  'emit "peerconnection: receive request" [error:%o]',
                  error
                );
                this.emit("peerconnection:setremotedescriptionfailed", error);
              });
  ...
  onTransportError() {
    console.error("onTransportError()");
  ...
  onRequestTimeout() {
    console.error("onRequestTimeout()");
  ...
  _createLocalDescription(type, constraints, readyCalled) {
    ...
    this._connectionPromiseQueue = this._connectionPromiseQueue
      ...
      .then(() => {
        ...
        return this._connection.setRemoteDescription(offer).catch((error) => {
          request.reply(488);
          console.error(
            'emit "peerconnection:setremotedescriptionfailed in dialog sdp" [error:%o]',
            error
          );
      ...
      .catch((error) => {
        console.error("_processInDialogSdpOffer() failed [error: %o]", error);
      });
  ...
  _getDTMFRTPSender() {
    ...
    if (!(sender && sender.dtmf)) {
      console.error("sendDTMF() | no local audio track to send DTMF with");
    ...
    switch (true) {
      ...
      case /^1[0-9]{2}$/.test(response.status_code): {
        ...
        this._connectionPromiseQueue = this._connectionPromiseQueue
          ...
          .catch((error) => {
            console.error(
              'emit "peerconnection:setremotedescriptionfailed 1xx invite response" [error:%o]',
              error
            );
          ...
          .then(() => {
            this._connection
              ...
              .catch((error) => {
                ...
                console.error(
                  'emit "peerconnection:setremotedescriptionfailed 2xx invite response" [error:%o]',
                  error
                );
    ...
    function onSucceeded(response) {
      ...
      this._connectionPromiseQueue = this._connectionPromiseQueue
        ...
        .catch((error) => {
          ...
          console.error(
            'emit "peerconnection:setremotedescriptionfailed sendReinvite onsucceded" [error:%o]',
            error
          );
      ...
      if (sdpOffer) {
        ...
        this._connectionPromiseQueue = this._connectionPromiseQueue
          ...
          .catch((error) => {
            ...
            console.error(
              'emit "peerconnection:setremotedescriptionfailed sendupdate onsucceeded" [error:%o]',
              error
            );
