  ...
  })(
    {
          ...
          var u = {
                ...
                if (o.isSocket(e)) t.push({ socket: e });
                  ...
                  try {
                    for (
                      ...
                      var l = s.value;
                      Object.prototype.hasOwnProperty.call(l, "socket") &&
                      o.isSocket(l.socket)
                        ? t.push(l)
                        : o.isSocket(l) && t.push({ socket: l });
                    }
                  } catch (e) {
                    (r = !0), (i = e);
                  } finally {
            ...
            optional: {
              authorization_user: function (e) {
                return -1 === s.parse('"' + e + '"', "quoted_string")
                  ? void 0
                  : e;
              },
              ...
              display_name: function (e) {
                return -1 === s.parse('"' + e + '"', "display_name")
                  ? void 0
                  : e;
              },
              ...
              session_timers_refresh_method: function (e) {
                if (
                  "string" == typeof e &&
                  ((e = e.toUpperCase()) === i.INVITE || e === i.UPDATE)
                )
                  return e;
              },
              password: function (e) {
        ...
        function (e, t, n) {
          ...
          t.exports = (function () {
            ...
            function e(t, n, r) {
              ...
              n instanceof i.IncomingResponse &&
                (s = n.status_code < 200 ? c.STATUS_EARLY : c.STATUS_CONFIRMED);
            ...
            return (
              r(e, [
                ...
                },
                {
                  key: "terminate",
                  value: function () {
                    u("dialog " + this._id.toString() + " deleted"),
                ...
                },
                {
                  ...
                  value: function (e) {
                    this._checkInDialogRequest(e) &&
                      (e.method === s.ACK && null !== this._ack_seqnum
                        ? (this._ack_seqnum = null)
                        : e.method === s.INVITE && (this._ack_seqnum = e.cseq),
                        ...
                        e.server_transaction.on("stateChanged", function n() {
                          (e.server_transaction.state !== a.C.STATUS_ACCEPTED &&
                            e.server_transaction.state !==
                              a.C.STATUS_COMPLETED &&
                            e.server_transaction.state !==
                              a.C.STATUS_TERMINATED) ||
                  ...
                  value: function (e) {
                    ...
                    408 === e.status_code || 481 === e.status_code
                      ...
                      ? this._reattempt
                        ...
                        : ((this._request.cseq.value =
                            this._dialog.local_seqnum +=
                              1),
                          (this._reattemptTimer = setTimeout(function () {
                            t._dialog.owner.status !== a.C.STATUS_TERMINATED &&
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return (
                        ...
                        this._qop &&
                          (e.push("qop=" + this._qop),
                          e.push('cnonce="' + this._cnonce + '"'),
                          e.push("nc=" + this._ncHex)),
                        "Digest " + e.join(", ")
                      );
                    },
                  },
          ...
          var a = (function (e) {
            ...
            o = (function (e) {
              ...
              function t(e) {
                ...
                return (
                  (n.code = 2),
                  (n.name = "INVALID_STATE_ERROR"),
                  (n.status = e),
                  (n.message = "Invalid status: " + e),
                  n
                );
              }
              return t;
            ...
            u = (function (e) {
              ...
              function t(e) {
                ...
                return (
                  (n.code = 4), (n.name = "NOT_READY_ERROR"), (n.message = e), n
                );
              }
              return t;
            })();
              ...
              parse: function (n, r) {
                var i = {
                  ...
                  Event: function () {
                    ...
                    null !== e &&
                      ((l = e[0]),
                      (e = void (Fn.event = l.join("").toLowerCase())));
                    var l;
                    null === e && (s = i);
                    return e;
                  },
                    ...
                    null !== e &&
                      (e = (function (e, t) {
                        if (
                          ...
                          Fn.params || (Fn.params = {}),
                          Fn.params.text && '"' === Fn.params.text[0])
                        ) {
                ...
                function A() {
                  var e, t, r, i, o;
                  for (
                    i = s, o = s, e = [], null === (t = m()) && (t = g());
                    null !== t;

                  )
                    e.push(t), null === (t = m()) && (t = g());
                  return (
                    null !== e
                      ? (58 === n.charCodeAt(s)
                          ? ((t = ":"), s++)
                ...
                function ee() {
                  ...
                  (t = s),
                    "sips" === n.substr(s, 4).toLowerCase()
                      ...
                      : ((e = null), 0 === a && u('"sips"')),
                    null !== e &&
                      ((r = e), (e = void (Fn.scheme = r.toLowerCase())));
                  var r;
                  return null === e && (s = t), e;
                }
                function te() {
                ...
                function ne() {
                  ...
                  (i = s),
                    ...
                    null !== e &&
                      ((c = i),
                      (e = void (Fn.user = decodeURIComponent(
                        n.substring(s - 1, c)
                      ))));
                  var c;
                  return null === e && (s = i), e;
                            ...
                            null === t &&
                              ...
                              null === t &&
                                (44 === n.charCodeAt(s)
                                  ...
                                  : ((t = null), 0 === a && u('","')))))));
                  null !== e &&
                    ((i = r), (e = void (Fn.password = n.substring(s, i))));
                  var i;
                  return null === e && (s = r), e;
                }
                function ae() {
                ...
                function oe() {
                  var e, t;
                  (t = s),
                    null === (e = le()) && null === (e = _e()) && (e = de()),
                    null !== e &&
                      ((r = t),
                      (Fn.host = n.substring(s, r).toLowerCase()),
                      (e = Fn.host));
                  var r;
                  return null === e && (s = t), e;
                }
                ...
                function Te() {
                  ...
                  (r = s),
                    ...
                    null !== e &&
                      ...
                      (e = void (Fn.uri_params.transport = o.toLowerCase())));
                  var o;
                  return null === e && (s = r), e;
                }
                function Ce() {
                  ...
                  (r = s),
                    ...
                    null !== e &&
                      ((o = e[1]),
                      Fn.uri_params || (Fn.uri_params = {}),
                      (e = void (Fn.uri_params.user = o.toLowerCase())));
                  var o;
                  return null === e && (s = r), e;
                }
                function Se() {
                ...
                function xe() {
                  ...
                  (i = s),
                    ...
                    null !== e &&
                      ...
                      (e = void (Fn.uri_headers[l]
                        ? Fn.uri_headers[l].push(c)
                        : (Fn.uri_headers[l] = [c]))));
                  var l, c;
                  return null === e && (s = i), e;
                }
                ...
                function Ye() {
                  ...
                  null !== e &&
                    ((l = i), (e = void (Fn.scheme = n.substring(s, l))));
                  var l;
                  return null === e && (s = i), e;
                }
                function $e() {
                ...
                function et() {
                  ...
                  null !== e &&
                    ((f = c), (e = void (Fn.sip_version = n.substring(s, f))));
                  var f;
                  return null === e && (s = c), e;
                }
                function tt() {
                ...
                function ht() {
                  ...
                  (t = s),
                    null !== (e = ft()) &&
                      ((n = e),
                      (e = void (Fn.status_code = parseInt(n.join("")))));
                  var n;
                  return null === e && (s = t), e;
                }
                function ft() {
                ...
                function pt() {
                  ...
                  null !== e &&
                    ((i = r),
                    (e = void (Fn.reason_phrase = n.substring(s, i))));
                  var i;
                  return null === e && (s = r), e;
                }
                function _t() {
                  ...
                  return (
                    null !== e &&
                      (e = (function (e) {
                        ...
                        try {
                          (t = new Hn(Fn.uri, Fn.display_name, Fn.params)),
                            delete Fn.uri,
                ...
                function mt() {
                  ...
                  null === e && (e = K()),
                    null !== e &&
                      ((u = a),
                      (c = e),
                      '"' === (c = n.substring(s, u).trim())[0] &&
                        (c = c.substring(1, c.length - 1)),
                      (e = void (Fn.display_name = c)));
                  var u, c;
                  return null === e && (s = a), e;
                }
                function gt() {
                ...
                function yt() {
                  ...
                  (i = s),
                    ...
                    "q" === n.substr(s, 1).toLowerCase()
                      ? ((e = n.substr(s, 1)), s++)
                      : ((e = null), 0 === a && u('"q"')),
                    null !== e && null !== (t = M()) && null !== (r = St())
                      ? (e = [e, t, r])
                      : ((e = null), (s = o)),
                    null !== e &&
                      ((l = e[2]),
                      Fn.params || (Fn.params = {}),
                      (e = void (Fn.params.q = l)));
                  var l;
                  return null === e && (s = i), e;
                }
                function Tt() {
                ...
                function St() {
                  ...
                  (l = s),
                    ...
                    null !== e
                      ...
                      : ((e = null), (s = c)),
                    null !== e &&
                      ((f = l), (e = parseFloat(n.substring(s, f))));
                  var f;
                  return null === e && (s = l), e;
                }
                function Et() {
                  ...
                  (r = s),
                    ...
                    null !== e &&
                      ...
                      (e = void (Fn.params[o.toLowerCase()] = l)));
                  var o, l;
                  return null === e && (s = r), e;
                }
                function bt() {
                ...
                function Ot() {
                  ...
                  return (
                    "message" === n.substr(s, 7).toLowerCase()
                      ? ((e = n.substr(s, 7)), (s += 7))
                      : ((e = null), 0 === a && u('"message"')),
                    null === e &&
                      ("multipart" === n.substr(s, 9).toLowerCase()
                        ? ((e = n.substr(s, 9)), (s += 9))
                        : ((e = null), 0 === a && u('"multipart"')),
                      null === e && (e = xt())),
                    e
                  );
                }
                ...
                function Lt() {
                  ...
                  null !== e &&
                    ((r = e), (e = void (Fn.value = parseInt(r.join("")))));
                  var r;
                  return null === e && (s = n), e;
                }
                function qt() {
                ...
                function Jt() {
                  var e, t;
                  (t = s),
                    null !== (e = z()) && ((n = e), (e = void (Fn.realm = n)));
                  var n;
                  return null === e && (s = t), e;
                }
                function Kt() {
                ...
                function $t() {
                  var e, t;
                  (t = s),
                    null !== (e = z()) && ((n = e), (e = void (Fn.nonce = n)));
                  var n;
                  return null === e && (s = t), e;
                }
                function Qt() {
                      ...
                      ? ("md5" === n.substr(s, 3).toLowerCase()
                        ...
                        null === r &&
                          ("md5-sess" === n.substr(s, 8).toLowerCase()
                            ? ((r = n.substr(s, 8)), (s += 8))
                            : ((r = null), 0 === a && u('"MD5-sess"')),
                          null === r && (r = O())),
                        null !== r ? (e = [e, t, r]) : ((e = null), (s = o)))
                      : ((e = null), (s = o)),
                    null !== e &&
                      ((l = e[2]), (e = void (Fn.algorithm = l.toUpperCase())));
                  var l;
                  return null === e && (s = i), e;
                }
                function en() {
                ...
                function tn() {
                  ...
                  (t = s),
                    ...
                    null !== e &&
                      ((r = e),
                      Fn.qop || (Fn.qop = []),
                      (e = void Fn.qop.push(r.toLowerCase())));
                  var r;
                  return null === e && (s = t), e;
                }
                function nn() {
                ...
                function sn() {
                  ...
                  null !== e &&
                    ((c = e[2]), (e = void (Fn.cause = parseInt(c.join("")))));
                  var c;
                  return null === e && (s = o), e;
                }
                function an() {
                  ...
                  (t = s),
                    ...
                    null === e &&
                      ("pending" === n.substr(s, 7).toLowerCase()
                        ? ((e = n.substr(s, 7)), (s += 7))
                        : ((e = null), 0 === a && u('"pending"')),
                      null === e &&
                        ("terminated" === n.substr(s, 10).toLowerCase()
                          ? ((e = n.substr(s, 10)), (s += 10))
                          : ((e = null), 0 === a && u('"terminated"')),
                        null === e && (e = O()))),
                    null !== e &&
                      ((r = t), (e = void (Fn.state = n.substring(s, r))));
                  var r;
                  return null === e && (s = t), e;
                }
                function ln() {
                  ...
                  (i = s),
                    ...
                    "reason" === n.substr(s, 6).toLowerCase()
                      ? ((e = n.substr(s, 6)), (s += 6))
                      : ((e = null), 0 === a && u('"reason"')),
                    null !== e && null !== (t = M()) && null !== (r = un())
                      ? (e = [e, t, r])
                      : ((e = null), (s = o)),
                    null !== e &&
                      (e = void (void 0 !== (l = e[2]) && (Fn.reason = l)));
                  var l;
                  null === e && (s = i),
                    null === e &&
                      ((i = s),
                      ...
                      null !== e && null !== (t = M()) && null !== (r = Ct())
                        ...
                        : ((e = null), (s = o)),
                      null !== e &&
                        (e = void (void 0 !== (d = e[2]) && (Fn.expires = d))),
                      null === e && (s = i),
                      null === e &&
                        ((i = s),
                        (o = s),
                        "retry_after" === n.substr(s, 11).toLowerCase()
                          ? ((e = n.substr(s, 11)), (s += 11))
                          : ((e = null), 0 === a && u('"retry_after"')),
                        null !== e && null !== (t = M()) && null !== (r = Ct())
                          ? (e = [e, t, r])
                          : ((e = null), (s = o)),
                        null !== e &&
                          (e = void (
                            void 0 !== (c = e[2]) && (Fn.retry_after = c)
                          )),
                        null === e && (s = i),
                        null === e && (e = Et())));
                  var c, d;
                          ...
                          null === e &&
                            ...
                            null === e &&
                              ("noresource" === n.substr(s, 10).toLowerCase()
                                ? ((e = n.substr(s, 10)), (s += 10))
                                : ((e = null), 0 === a && u('"noresource"')),
                              null === e &&
                                ("invariant" === n.substr(s, 9).toLowerCase()
                                  ? ((e = n.substr(s, 9)), (s += 9))
                                  : ((e = null), 0 === a && u('"invariant"')),
                                null === e && (e = O()))))))),
                    e
                  );
                }
                ...
                function mn() {
                  ...
                  return (
                    null !== e &&
                      (e = void (
                        "undefined" != typeof response_port &&
                        (Fn.rport = response_port.join(""))
                      )),
                    null === e && (s = o),
                    e
                  );
                ...
                function Sn() {
                  var e, t;
                  (t = s),
                    null === (e = _e()) && null === (e = de()) && (e = le()),
                    null !== e &&
                      ((r = t), (e = void (Fn.host = n.substring(s, r))));
                  var r;
                  return null === e && (s = t), e;
                }
                function En() {
                  ...
                  (a = s),
                    ...
                    null !== (i = null !== (i = d()) ? i : "")
                      ...
                      : ((e = null), (s = o)),
                    null !== e &&
                      ((l = e), (e = void (Fn.port = parseInt(l.join("")))));
                  var l;
                  return null === e && (s = a), e;
                }
                function bn() {
                ...
                function wn() {
                  ...
                  (i = s),
                    ...
                    null !== e && null !== (t = M())
                      ...
                      : ((e = null), (s = o)),
                    null !== e &&
                      ((l = e[2]), (e = void (Fn.refresher = l.toLowerCase())));
                  var l;
                  return null === e && (s = i), e;
                }
                function In() {
                ...
                function kn() {
                  ...
                  (f = s),
                    ...
                    null !== (e = On())
                      ...
                      : ((e = null), (s = p)),
                    null !== e &&
                      ((_ = f), e[0], (e = void (Fn = n.substring(s + 5, _))));
                  var _;
                  return null === e && (s = f), e;
                }
                function Pn() {
                ...
                function Dn() {
                  ...
                  (i = s),
                    ...
                    null !== (e = D())
                      ...
                      : ((e = null), (s = o)),
                    null !== e &&
                      ((c = i), (e = void (Fn.call_id = n.substring(s, c))));
                  var c;
                  return null === e && (s = i), e;
                }
                function Nn() {
            ...
            return (
              r(t, [
                  ...
                  value: function (e, t) {
                    ...
                    for (var h in c)
                      Object.prototype.hasOwnProperty.call(c, h) &&
                        this.on(h, c[h]);
                    u.push("Content-Type: " + d),
                      (this._request = new a.OutgoingRequest(
                        s.MESSAGE,
                        e,
                        this._ua,
                        null,
                ...
                },
                {
                  ...
                  value: function () {
                    this._closed ||
                      this._failed("system", null, s.causes.REQUEST_TIMEOUT);
                  },
                },
                {
                  ...
                  value: function () {
                    this._closed ||
                      this._failed("system", null, s.causes.CONNECTION_ERROR);
                  },
                },
                {
                  key: "_close",
            ...
            return (
              r(e, [
                  ...
                  value: function (e, t) {
                    e &&
                      (this._parameters[e.toLowerCase()] =
                        void 0 === t || null === t ? null : t.toString());
                  },
                },
                {
                  key: "getParam",
                ...
                },
                {
                  ...
                  value: function () {
                    var e =
                      this._display_name || 0 === this._display_name
                        ? '"' + this._display_name + '" '
                        : "";
        ...
        function (e, t, n) {
          ...
          (s.log = console.warn.bind(console)),
            (n.parseMessage = function (e, t) {
              ...
              if (-1 !== u) {
                ...
                if (-1 !== d) {
                  d.status_code
                    ? (((n = new i.IncomingResponse()).status_code =
                        d.status_code),
                      (n.reason_phrase = d.reason_phrase))
                    : (((n = new i.IncomingRequest(t)).method = d.method),
                      (n.ruri = d.uri)),
                    (n.data = e);
                  for (var h = u + 2; ; ) {
                    if (-2 === (u = a(e, h))) {
                    ...
                    if (-1 === u)
                      return void s("parseMessage() | malformed message");
                    if (!0 !== (d = o(n, e, h, u)))
                      return void s("parseMessage() |", d.error);
                    h = u + 2;
                  }
                ...
                s(
                  'parseMessage() | error parsing first line of SIP message: "' +
                    c +
                    '"'
                );
          ...
          function o(e, t, n, s) {
            ...
            switch (l.toLowerCase()) {
              ...
              case "f":
                e.setHeader("from", u),
                  (a = e.parseHeader("from")) &&
                    ((e.from = a), (e.from_tag = a.getParam("tag")));
                break;
              case "to":
              case "t":
                e.setHeader("to", u),
                  (a = e.parseHeader("to")) &&
                    ((e.to = a), (e.to_tag = a.getParam("tag")));
                break;
              case "record-route":
                if (-1 === (a = r.parse(u, "Record_Route"))) a = void 0;
                  ...
                  try {
                    for (
                      ...
                      e.addHeader(
                        "record-route",
                        u.substring(_.possition, _.offset)
                      ),
              ...
              case "call-id":
              case "i":
                e.setHeader("call-id", u),
                  (a = e.parseHeader("call-id")) && (e.call_id = u);
                break;
              case "contact":
              case "m":
                if (-1 === (a = r.parse(u, "Contact"))) a = void 0;
                  ...
                  try {
                    for (
                      ...
                      e.addHeader(
                        "contact",
                        u.substring(C.possition, C.offset)
                      ),
                        (e.headers.Contact[
              ...
              case "cseq":
                e.setHeader("cseq", u),
                  (a = e.parseHeader("cseq")) && (e.cseq = a.value),
                  e instanceof i.IncomingResponse && (e.method = a.method);
                break;
              case "max-forwards":
                e.setHeader("max-forwards", u),
                  (a = e.parseHeader("max-forwards"));
                break;
              case "www-authenticate":
                e.setHeader("www-authenticate", u),
                  (a = e.parseHeader("www-authenticate"));
                break;
              case "proxy-authenticate":
                e.setHeader("proxy-authenticate", u),
                  (a = e.parseHeader("proxy-authenticate"));
                break;
              case "session-expires":
              case "x":
                e.setHeader("session-expires", u),
                  (a = e.parseHeader("session-expires")) &&
                    ((e.session_expires = a.expires),
                    (e.session_expires_refresher = a.refresher));
                break;
              case "refer-to":
              case "r":
                e.setHeader("refer-to", u),
                  (a = e.parseHeader("refer-to")) && (e.refer_to = a);
                break;
              case "replaces":
                e.setHeader("replaces", u),
                  (a = e.parseHeader("replaces")) && (e.replaces = a);
                break;
              case "event":
              case "o":
                e.setHeader("event", u),
                  (a = e.parseHeader("event")) && (e.event = a);
                break;
              default:
                e.addHeader(l, u), (a = 0);
            }
            return (
              void 0 !== a || { error: 'error parsing header "' + l + '"' }
            );
          }
        },
            ...
            function t(e) {
              ...
              return (
                ...
                (n._sessionTimers = {
                  ...
                  refreshMethod:
                    n._ua.configuration.session_timers_refresh_method,
              ...
              i(t, [
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (this._status !== C.STATUS_NULL)
                      throw new l.InvalidStateError(this._status);
                    if (!window.RTCPeerConnection)
                      throw new l.NotSupportedError("WebRTC not supported");
                    if (!(e = this._ua.normalizeTarget(e)))
                      throw new TypeError("Invalid target: " + r);
                    this._sessionTimers.enabled &&
                      ...
                      (t.sessionTimersExpires >= o.MIN_SESSION_EXPIRES
                        ...
                        : (this._sessionTimers.defaultExpires =
                            o.SESSION_EXPIRES));
                    for (var _ in i)
                      Object.prototype.hasOwnProperty.call(i, _) &&
                        this.on(_, i[_]);
                    ...
                    (this._contact = this._ua.contact.toString({
                      ...
                      (this._request = new h.InitialOutgoingInviteRequest(
                        e,
                        this._ua,
                        m,
                        s
                        ...
                        this._createDialog(e, "UAS", !0)
                          ? (e.body
                            ...
                            (this._timers.userNoAnswerTimer = setTimeout(
                              function () {
                                e.reply(408),
                                  n._failed("local", null, o.causes.NO_ANSWER);
                              },
                            ...
                            r &&
                              (this._timers.expiresTimer = setTimeout(
                                function () {
                                  n._status === C.STATUS_WAITING_FOR_ANSWER &&
                                    (e.reply(487),
                                    n._failed(
                                      "system",
                                      null,
                  ...
                  value: function () {
                    ...
                    if (
                      ...
                      clearTimeout(this._timers.userNoAnswerTimer),
                        r.unshift("Contact: " + this._contact);
                      var m = n.parseSDP();
                      ...
                      try {
                        for (
                          var b, R = m.media[Symbol.iterator]();
                          !(g = (b = R.next()).done);
                          g = !0
                        ) {
                          var A = b.value;
                          "audio" === A.type &&
                            ((f = !0),
                            (A.direction && "sendrecv" !== A.direction) ||
                              (_ = !0)),
                            "video" === A.type &&
                              ((p = !0),
                              (A.direction && "sendrecv" !== A.direction) ||
                      ...
                      s || void 0 !== i.audio || (i.audio = _),
                        ...
                        Promise.resolve()
                              ...
                              (i.audio || i.video
                                ? ((e._localMediaStreamLocallyGenerated = !0),
                                  navigator.mediaDevices
                                    .getUserMedia(i)
                                    .catch(function (t) {
                                      if (e._status === C.STATUS_TERMINATED)
                                      ...
                                      throw (
                                        ...
                                        e._failed(
                                          "local",
                                          null,
                                          o.causes.USER_DENIED_MEDIA_ACCESS
                                        ),
                                        T(
                          ...
                          .then(function () {
                            ...
                            return (
                              ...
                              e._late_sdp
                                ...
                                : e
                                    ._createLocalDescription("answer", d)
                                    .catch(function () {
                                      throw (
                                        (n.reply(500),
                                        new Error(
                          ...
                          .catch(function (t) {
                            e._status !== C.STATUS_TERMINATED && T(t);
                          });
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    switch (this._status) {
                      ...
                      case C.STATUS_1XX_RECEIVED:
                        if (
                          (y("canceling session"), a && (a < 200 || a >= 700))
                        )
                      ...
                      case C.STATUS_ANSWERED:
                        if (
                          ...
                          throw new TypeError("Invalid status_code: " + a);
                        this._request.reply(a, d, r, i),
                          this._failed("local", null, o.causes.REJECTED);
                        break;
                      case C.STATUS_WAITING_FOR_ACK:
                      case C.STATUS_CONFIRMED:
                        if (
                          (y("terminating session"),
                          (d = t.reason_phrase || o.REASON_PHRASE[a] || ""),
                          a && (a < 200 || a >= 700))
                        )
                          throw new TypeError("Invalid status_code: " + a);
                        if (
                          ...
                          this.sendRequest(o.BYE, { extraHeaders: r, body: i }),
                            this._ended("local", null, n);
                    }
                  },
                },
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    !1 === this._audioMuted &&
                      ...
                      ((t = !0),
                      (this._audioMuted = !0),
                      this._toogleMuteAudio(!0)),
                      !1 === this._videoMuted &&
                        e.video &&
                        ((n = !0),
                        (this._videoMuted = !0),
                        this._toogleMuteVideo(!0)),
                      (!0 !== t && !0 !== n) ||
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    !0 === this._audioMuted &&
                      ...
                      ((t = !0),
                      (this._audioMuted = !1),
                      !1 === this._localHold && this._toogleMuteAudio(!1)),
                      !0 === this._videoMuted &&
                        e.video &&
                        ((n = !0),
                        (this._videoMuted = !1),
                        !1 === this._localHold && this._toogleMuteVideo(!1)),
                      (!0 !== t && !0 !== n) ||
                  ...
                  value: function (e) {
                    ...
                    if ((y("receiveRequest()"), e.method === o.CANCEL))
                      (this._status !== C.STATUS_WAITING_FOR_ANSWER &&
                        ...
                        this._failed("remote", e, o.causes.CANCELED));
                    else
                      switch (e.method) {
                        case o.ACK:
                          ...
                          if (
                            ...
                            this._connectionPromiseQueue =
                              this._connectionPromiseQueue
                                ...
                                .catch(function (e) {
                                  t.terminate({
                                    cause: o.causes.BAD_MEDIA_DESCRIPTION,
                                    status_code: 488,
                                  }),
                                    T(
                                      'emit "peerconnection:setremotedescriptionfailed" [error:%o]',
                        ...
                        case o.BYE:
                          this._status === C.STATUS_CONFIRMED
                            ? (e.reply(200),
                              this._ended("remote", e, o.causes.BYE))
                            : this._status === C.STATUS_INVITE_RECEIVED
                            ? (e.reply(200),
                  ...
                  value: function () {
                    T("onTransportError()"),
                      this._status !== C.STATUS_TERMINATED &&
                        this.terminate({
                          status_code: 500,
                          reason_phrase: o.causes.CONNECTION_ERROR,
                          cause: o.causes.CONNECTION_ERROR,
                        });
                  },
                },
                {
                  ...
                  value: function () {
                    T("onRequestTimeout()"),
                      this._status !== C.STATUS_TERMINATED &&
                        this.terminate({
                          status_code: 408,
                          reason_phrase: o.causes.REQUEST_TIMEOUT,
                  ...
                  value: function () {
                    T("onDialogError()"),
                      this._status !== C.STATUS_TERMINATED &&
                        this.terminate({
                          status_code: 500,
                          reason_phrase: o.causes.DIALOG_ERROR,
                          cause: o.causes.DIALOG_ERROR,
                        });
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    if ((y("close()"), this._status !== C.STATUS_TERMINATED)) {
                      if (
                        ((this._status = C.STATUS_TERMINATED), this._connection)
                      )
                        try {
                      ...
                      this._localMediaStream &&
                        ...
                        (y("close() | closing local MediaStream"),
                        c.closeMediaStream(this._localMediaStream));
                      ...
                      this._connection.addEventListener(
                        ...
                        function () {
                          "failed" === n._connection.iceConnectionState &&
                            n.terminate({
                              cause: o.causes.RTP_TIMEOUT,
                              status_code: 408,
                              reason_phrase: o.causes.RTP_TIMEOUT,
                            });
                        }
                      ),
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    if (
                      ...
                      throw new Error(
                        'createLocalDescription() | invalid type "' + e + '"'
                      );
                          ...
                          return new Promise(function (t) {
                            var i = !1,
                              ...
                              a = function () {
                                ...
                                y('emit "sdp"'), n.emit("sdp", a), t(a.sdp);
                              };
                            r.addEventListener(
                              "icecandidate",
                              (s = function (e) {
                    ...
                    if (n)
                      return (
                        ...
                        ((a = new f(this, e, t, f.C.STATUS_EARLY)).error
                          ? (y(a.error),
                            this._failed("remote", e, o.causes.INTERNAL_ERROR),
                            !1)
                  ...
                  value: function (e) {
                    ...
                    if ((this.emit("reinvite", r), !i)) {
                      ...
                      if ("application/sdp" !== n)
                        return y("invalid Content-Type"), void e.reply(415);
                      this._processInDialogSdpOffer(e)
                        .then(function (e) {
                          t._status !== C.STATUS_TERMINATED && s.call(t, e);
                        })
                        .catch(function (e) {
                          T(e);
                        });
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    try {
                      for (
                        var o, l = n.media[Symbol.iterator]();
                        !(i = (o = l.next()).done);
                        i = !0
                      ) {
                        var u = o.value;
                        if (-1 !== S.indexOf(u.type)) {
                          var c = u.direction || n.direction || "sendrecv";
                          if ("sendonly" !== c && "inactive" !== c) {
                            r = !1;
                            break;
                          }
                          r = !0;
                    ...
                    return (
                      (this._connectionPromiseQueue =
                        this._connectionPromiseQueue
                          .then(function () {
                            if (t._status === C.STATUS_TERMINATED)
                              throw new Error("terminated");
                            return t._connection
                              .setRemoteDescription(h)
                              .catch(function (n) {
                                throw (
                                  (e.reply(488),
                                  T(
                          ...
                          .then(function () {
                            ...
                            return t
                              ...
                              .catch(function () {
                                throw (
                                  (e.reply(500),
                                  new Error("_createLocalDescription() failed"))
                                );
                              });
                          })),
                      this._connectionPromiseQueue
                ...
                },
                {
                  ...
                  value: function (e) {
                    var n = this;
                    if ((y("receiveRefer()"), void 0 === r(e.refer_to)))
                      return (
                        y("no Refer-To header field present in REFER"),
                        void e.reply(400)
                      );
                    if (e.refer_to.uri.scheme !== o.SIP)
                      return (
                        y(
                        ...
                        accept: function (r, s) {
                          (function (n) {
                            ...
                            if (
                              ...
                              (r.extraHeaders = c.cloneArray(r.extraHeaders)),
                                r.extraHeaders.push("Replaces: " + a);
                            }
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    this.emit("replaces", {
                      ...
                      reject: function () {
                        (function () {
                          y("Replaced INVITE rejected by the user"),
                            e.reply(486);
                        }.call(n));
                      },
                    });
                ...
                },
                {
                  ...
                  value: function (e, t, n) {
                    ...
                    Promise.resolve()
                          ...
                          (e.audio || e.video
                            ? ((r._localMediaStreamLocallyGenerated = !0),
                              navigator.mediaDevices
                                .getUserMedia(e)
                                .catch(function (e) {
                                  if (r._status === C.STATUS_TERMINATED)
                                    throw new Error("terminated");
                                  throw (
                                    (r._failed(
                                      "local",
                      ...
                      .then(function (e) {
                        if (r._is_canceled || r._status === C.STATUS_TERMINATED)
                          throw new Error("terminated");
                        (r._request.body = e),
                          (r._status = C.STATUS_INVITE_SENT),
                          y('emit "sending" [request:%o]', r._request),
                          r.emit("sending", { request: r._request }),
                          i.send();
                      })
                      .catch(function (e) {
                        r._status !== C.STATUS_TERMINATED && T(e);
                      });
                  },
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (
                      ...
                      return void 0 !== n.error
                        ? void y(n.error)
                        : (this.sendRequest(o.ACK),
                          void this.sendRequest(o.BYE));
                    }
                          ...
                          if (((this._status = C.STATUS_CONFIRMED), !e.body)) {
                            this._acceptAndTerminate(
                              ...
                              this._failed(
                                "remote",
                                e,
                                o.causes.BAD_MEDIA_DESCRIPTION
                              );
                            break;
                          }
                  ...
                  value: function () {
                    ...
                    function l(e) {
                      ...
                      if (this._status !== C.STATUS_TERMINATED && !a)
                        if (
                          (this._handleSessionTimersInIncomingResponse(e), s)
                        ) {
                ...
                },
                {
                  ...
                  value: function (e, t, n) {
                    ...
                    var r = [];
                    t &&
                      ((n = n || o.REASON_PHRASE[t] || ""),
                      r.push("Reason: SIP ;cause=" + t + '; text="' + n + '"')),
                      (this._dialog || this._createDialog(e, "UAC")) &&
                        (this.sendRequest(o.ACK),
                        this.sendRequest(o.BYE, { extraHeaders: r })),
                      (this._status = C.STATUS_TERMINATED);
                  },
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (
                      ((e = a.parse(e)), this._localHold && !this._remoteHold)
                    ) {
                      ...
                      try {
                        for (
                          var i, s = e.media[Symbol.iterator]();
                          !(t = (i = s.next()).done);
                          t = !0
                        ) {
                          var o = i.value;
                      ...
                      try {
                        for (
                          var d, h = e.media[Symbol.iterator]();
                          !(l = (d = h.next()).done);
                          l = !0
                        ) {
                          var f = d.value;
                      ...
                      try {
                        for (
                          var m, g = e.media[Symbol.iterator]();
                          !(p = (m = g.next()).done);
                          p = !0
                        ) {
                          var T = m.value;
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    if (this._sessionTimers.enabled) {
                      var n = void 0;
                      e.session_expires &&
                      e.session_expires >= o.MIN_SESSION_EXPIRES
                        ? ((this._sessionTimers.currentExpires =
                            e.session_expires),
                      ...
                      this._sessionTimers.refresher
                        ? (this._sessionTimers.timer = setTimeout(function () {
                            e._status !== C.STATUS_TERMINATED &&
                              ...
                              e._sessionTimers.refreshMethod === o.UPDATE
                                ? e._sendUpdate()
                                : e._sendReinvite());
                          }, 500 * t))
                        : (this._sessionTimers.timer = setTimeout(function () {
      ...
      13: [
        function (e, t, n) {
          ...
          e("debug")("JsSIP:ERROR:RTCSession:DTMF").log =
              ...
              r(t, [
                {
                  ...
                  value: function (e) {
                    ...
                    if (
                      ((this.eventHandlers = n.eventHandlers || {}),
                      "string" == typeof e)
                    )
                      e = e.toUpperCase();
                    else {
                  ...
                  value: function (e) {
                    ...
                    this._duration || (this._duration = u.DEFAULT_DURATION),
                      this._tone
                        ...
                        : l("invalid INFO DTMF received, discarded");
                  },
                },
                {
                  key: "tone",
      ...
      14: [
        function (e, t, n) {
          ...
          var i = e("events").EventEmitter;
          e("debug")("JsSIP:ERROR:RTCSession:Info").log =
            console.warn.bind(console);
          var s = e("../Constants"),
            a = e("../Exceptions"),
            o = e("../Utils");
                    ...
                    if ((s("notify()"), !1 !== this._active)) {
                      ...
                      (n =
                        e >= 200
                          ...
                          : "active;expires=" + this._expires),
                        this._session.sendRequest(i.NOTIFY, {
                          extraHeaders: [
                            "Event: " + a.event_type + ";id=" + this._id,
                            "Subscription-State: " + n,
                            "Content-Type: " + a.body_type,
                          ],
                          body: "SIP/2.0 " + e + " " + t,
                          eventHandlers: {
                            onErrorResponse: function () {
              ...
              r(t, [
                {
                  ...
                  value: function (e) {
                    ...
                    var c =
                      "Refer-To: <" + e + (u ? "?Replaces=" + u : "") + ">";
                    r.push(c), r.push("Contact: " + this._session.contact);
                  ...
                  value: function (e) {
                    if ((l("receiveNotify()"), e.body)) {
                      ...
                      if (-1 !== t)
                        ...
                        l(
                          'receiveNotify() | error parsing NOTIFY body: "' +
                            e.body +
                            '"'
                        );
                    }
                  ...
                  value: function (e) {
                    ...
                    for (var t in e)
                      if (Object.prototype.hasOwnProperty.call(e, t)) {
                        var n = e[t];
                        (this._extraContactParams += ";" + t),
                          n && (this._extraContactParams += "=" + n);
                      }
                  },
                },
                {
                            ...
                            if (t.cseq === e._cseq)
                              switch (
                                ...
                                case /^2[0-9]{2}$/.test(t.status_code):
                                  ...
                                  for (; a--; ) {
                                    if (
                                      (n = t.parseHeader("contact", a)).uri
                                        .user === e._ua.contact.uri.user
                                    ) {
                                  ...
                                  !r &&
                                    ...
                                    n.hasParam("temp-gruu") &&
                                      (e._ua.contact.temp_gruu = n
                                        .getParam("temp-gruu")
                                        .replace(/"/g, "")),
                                    n.hasParam("pub-gruu") &&
                                      (e._ua.contact.pub_gruu = n
                                        .getParam("pub-gruu")
                                        .replace(/"/g, "")),
                                    e._registered ||
                                      ((e._registered = !0),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    if (this._registered) {
                      ...
                      t.all
                        ? n.push("Contact: *" + this._extraContactParams)
                        : n.push(
                            "Contact: " +
                              this._contact +
                              ";expires=0" +
      ...
      19: [
        function (e, t, n) {
          ...
          var o = e("sdp-transform"),
            ...
            f = (function () {
              function e(t, n, r, i, s, o) {
                ...
                (i = i || {}),
                  ...
                  i.route_set
                    ...
                    : r.configuration.use_preloaded_route &&
                      this.setHeader(
                        "route",
                        "<" + r.transport.sip_uri + ";lr>"
                      ),
                  this.setHeader("via", ""),
                  this.setHeader("max-forwards", l.MAX_FORWARDS);
                var d =
                  i.to_display_name || 0 === i.to_display_name
                    ? '"' + i.to_display_name + '" '
                    : "";
                (d += "<" + (i.to_uri || n) + ">"),
                  (d += i.to_tag ? ";tag=" + i.to_tag : ""),
                  (this.to = c.parse(d)),
                  this.setHeader("to", d);
                var h = void 0;
                (h =
                ...
                var f =
                  i.call_id ||
                  r.configuration.jssip_id + u.createRandomToken(15);
                ...
                r(e, [
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (t) {
                        ...
                        try {
                          for (
                            var a, o = this.extraHeaders[Symbol.iterator]();
                            !(r = (a = o.next()).done);
                            r = !0
                          ) {
                            var l = a.value;
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      try {
                        for (
                          var p, _ = this.extraHeaders[Symbol.iterator]();
                          !(d = (p = _.next()).done);
                          d = !0
                        ) {
                          var v = p.value;
                          c.test(v) &&
                            n.push(v.substring(v.indexOf(":") + 1).trim());
                        }
                      } catch (e) {
                        (h = !0), (f = e);
                      } finally {
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      try {
                        for (
                          var s, a = this.extraHeaders[Symbol.iterator]();
                          !(n = (s = a.next()).done);
                          n = !0
                        ) {
                          var o = s.value;
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      return !e && this.sdp
                        ? this.sdp
                        : ((this.sdp = o.parse(this.body || "")), this.sdp);
                    },
                  },
                  {
                    key: "toString",
                    value: function () {
                      ...
                      for (var t in this.headers)
                        if (
                          ...
                          try {
                            for (
                              var s, a = this.headers[t][Symbol.iterator]();
                              !(n = (s = a.next()).done);
                              n = !0
                            ) {
                              e += t + ": " + s.value + "\r\n";
                      ...
                      try {
                        for (
                          var h, f = this.extraHeaders[Symbol.iterator]();
                          !(o = (h = f.next()).done);
                          o = !0
                        ) {
                          e += h.value.trim() + "\r\n";
                ...
                r(t, [
                  {
                    ...
                    value: function (e, t, n, r, i, s) {
                      ...
                      !this.to_tag && e > 100
                        ...
                        (c +=
                          "CSeq: " + this.cseq + " " + this.method + "\r\n");
                      var E = !0,
                        b = !1,
                        R = void 0;
                      try {
                        for (
                          var A, w = n[Symbol.iterator]();
                          !(E = (A = w.next()).done);
                          E = !0
                        ) {
                          c += A.value.trim() + "\r\n";
          ...
          t.exports = {
            OutgoingRequest: f,
            InitialOutgoingInviteRequest: p,
            IncomingRequest: v,
            IncomingResponse: m,
          };
        },
          ...
          (s.log = console.warn.bind(console)),
            (n.isSocket = function (e) {
              ...
              try {
                if (!r.isString(e.url))
                  throw (
                    (s("missing or invalid JsSIP.Socket url property"),
                    new Error())
                  );
                ...
                if (-1 === i.parse(e.sip_uri, "SIP_URI"))
                  throw (
                    (s("missing or invalid JsSIP.Socket sip_uri property"),
                    new Error())
                  );
              } catch (e) {
                return !1;
              ...
              try {
                ["connect", "disconnect", "send"].forEach(function (t) {
                  if (!r.isFunction(e[t]))
                    throw (
                      (s("missing or invalid JsSIP.Socket method: " + t),
                      new Error())
                    );
                });
              } catch (e) {
          ...
          var o = e("events").EventEmitter,
            ...
            m = (function (e) {
              ...
              function t(e, n, r, a) {
                ...
                return (
                  (l += " " + e.configuration.via_host + ";branch=" + o.id),
                  o.request.setHeader("via", l),
                  o.ua.newTransaction(o),
                  o
                );
              }
              return (
                r(t, [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      d(
                        "transport error occurred, deleting transaction " +
                          this.id
                      ),
                        clearTimeout(this.F),
                        clearTimeout(this.K),
              ...
              return (
                r(t, [
                  ...
                  },
                  {
                    key: "timer_D",
                    value: function () {
                      h("Timer D expired for transaction " + this.id),
                        clearTimeout(this.B),
                        this.stateChanged(v.STATUS_TERMINATED),
                        this.ua.destroyTransaction(this);
                    },
                  ...
                  },
                  {
                    ...
                    value: function () {
                      _("Timer H expired for transaction " + this.id),
                        this.state === v.STATUS_COMPLETED &&
                          _("ACK not received, dialog will be terminated"),
                        this.stateChanged(v.STATUS_TERMINATED),
                        this.ua.destroyTransaction(this);
                    },
                  },
            ...
            checkTransaction: function (e, t) {
              ...
              switch (t.method) {
                ...
                case l.ACK:
                  ...
                  break;
                case l.CANCEL:
                  return (r = n.ist[t.via_branch])
                    ? (t.reply_sl(200), r.state !== v.STATUS_PROCEEDING)
                    : (t.reply_sl(481), !0);
                default:
            ...
            return (
              r(e, [
                ...
                },
                {
                  key: "send",
                  value: function (e) {
                    if ((s("send()"), !this.isConnected()))
                      return (
                        a("unable to send message, transport is not connected"),
                        !1
                      );
                    var t = e.toString();
                    return (
                  ...
                  value: function () {
                    ...
                    if (
                      (this.sockets.forEach(function (t) {
                        t.status !== o.SOCKET_STATUS_ERROR &&
                          (0 === e.length
                            ? e.push(t)
                            : t.weight > e[0].weight
                            ? (e = [t])
                      ...
                      this.close_requested ||
                        (this.sockets.forEach(function (e) {
                          this.socket === e.socket &&
                            (e.status = o.SOCKET_STATUS_ERROR);
                        }, this),
                        this._reconnect(e));
                  },
                },
          ...
          t.exports = (function (e) {
            ...
            function t(e) {
              ...
              try {
                ...
                throw (
                  ((n._status = C.STATUS_NOT_READY),
                  (n._error = C.CONFIGURATION_ERROR),
                  e)
                );
              }
                  ...
                  value: function (e, t) {
                    switch (e) {
                      ...
                      case "ha1":
                        ...
                        break;
                      case "display_name":
                        if (-1 === p.parse('"' + t + '"', "display_name"))
                          return T('set() | wrong "display_name"'), !1;
                        this._configuration.display_name = t;
                        break;
                      default:
                        return (
                          T('set() | cannot set "%s" parameter in runtime', e),
                          !1
                        );
                    }
                    return !0;
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (
                      ...
                      return (
                        y("Request-URI does not point to us"),
                        void (e.method !== s.ACK && e.reply_sl(404))
                      );
                    if (e.ruri.scheme !== s.SIPS) {
                      if (!u.checkTransaction(this, e)) {
                        if (
                          (t === s.INVITE
                            ? new u.InviteServerTransaction(
                                this,
                                this._transport,
                                e
                              )
                            : t !== s.ACK &&
                              t !== s.CANCEL &&
                              new u.NonInviteServerTransaction(
                                this,
                                this._transport,
                                e
                              ),
                ...
                },
                {
                  ...
                  value: function (e, t, n) {
                    var r = e + t + n,
                      i = this._dialogs[r];
                    return (
                      i || ((r = e + n + t), (i = this._dialogs[r]) || null)
                    );
                  },
                },
                {
                  ...
                  value: function (e) {
                    ...
                    0 === this._configuration.display_name &&
                      ...
                      this._configuration.instance_id ||
                        (this._configuration.instance_id = d.newUUID()),
                            ...
                            for (
                              ...
                              for (var o in this._transactions[a])
                                Object.prototype.hasOwnProperty.call(
                                  ...
                                  this._transactions[a][o].onTransportError();
                            }
                          } catch (e) {
                            (n = !0), (r = e);
                          } finally {
                    ...
                    (this._configuration.no_answer_timeout *= 1e3),
                      this._configuration.contact_uri
                        ...
                        : (this._configuration.contact_uri = new f(
                            "sip",
                            d.createRandomToken(8),
                            this._configuration.via_host,
                            null,
                            { transport: "ws" }
                          )),
                    ...
                    for (var i in this._configuration)
                      Object.prototype.hasOwnProperty.call(
                        ...
                        (-1 !== r.indexOf(i)
                          ? Object.defineProperty(this._configuration, i, {
                              writable: !0,
                              configurable: !1,
                            })
                          : Object.defineProperty(this._configuration, i, {
                          ...
                          default:
                            y(
                              "- " +
                                a +
                                ": " +
                                JSON.stringify(this._configuration[a])
                            );
                        }
                  },
                },
            ...
            return (
              r(e, [
                ...
                },
                {
                  ...
                  value: function (e) {
                    if (e)
                      return !!this._headers.hasOwnProperty(s.headerize(e));
                  },
                },
                {
                  key: "deleteHeader",
                  value: function (e) {
                    if (
                      ((e = s.headerize(e)), this._headers.hasOwnProperty(e))
                    ) {
                ...
                },
                {
                  ...
                  value: function () {
                    var e = [],
                      t = this._scheme + ":";
                    this._user && (t += s.escapeUser(this._user) + "@"),
                      (t += this._host),
                    ...
                    for (var n in this._parameters)
                      Object.prototype.hasOwnProperty.call(
                        ...
                        null !== this._parameters[n] &&
                          (t += "=" + this._parameters[n]));
                    for (var r in this._headers)
                      if (
                        Object.prototype.hasOwnProperty.call(this._headers, r)
                      ) {
                        var i = !0,
                          a = !1,
                          o = void 0;
                        try {
                          for (
                            var l, u = this._headers[r][Symbol.iterator]();
                            !(i = (l = u.next()).done);
                            i = !0
                          ) {
                            var c = l.value;
        ...
        function (e, t, n) {
          ...
          (n.newTag = function () {
            ...
            (n.hostType = function (e) {
              if (e)
                return -1 !== (e = a.parse(e, "host")) ? e.host_type : void 0;
            });
          ...
          (n.normalizeTarget = function (e, t) {
              ...
              if ("string" == typeof e) {
                ...
                switch (n.length) {
                  ...
                  case 2:
                    ...
                    break;
                  default:
                    (r = n.slice(0, n.length - 1).join("@")),
                      (a = n[n.length - 1]);
                }
                (r = r.replace(/^(sips?|tel):/i, "")),
                  /^[-.()]*\+?[0-9\-.()]+$/.test(r) &&
                    (r = r.replace(/[-.()]/g, "")),
                  (e = i.SIP + ":" + u(r) + "@" + a);
                var o = void 0;
            ...
            (n.headerize = function (e) {
              ...
              for (s = 0; s < i; s++)
                0 !== s && (r += "-"),
                  (r += n[s].charAt(0).toUpperCase() + n[s].substring(1));
              return t[r] && (r = t[r]), r;
            }),
            (n.sipErrorCause = function (e) {
              for (var t in i.SIP_ERROR_CAUSES)
                if (-1 !== i.SIP_ERROR_CAUSES[t].indexOf(e)) return i.causes[t];
            ...
            (n.calculateMD5 = function (e) {
              ...
              function o(e) {
                var t = "",
                  ...
                  r = void 0;
                for (r = 0; r <= 3; r++)
                  t += (n = "0" + ((e >>> (8 * r)) & 255).toString(16)).substr(
                    n.length - 2,
                    2
                  );
                return t;
                  ...
                  (_ = a(
                    (_ = a(
                      (_ = a(
                        (_ = a(
                          (_ = s(
                            (_ = s(
                              ...
                              (v = s(
                                ...
                                (m = s(
                                  m,
                                  (p = s(p, _, v, m, l[u + 13], 4, 681279174)),
                                  _,
                                  v,
                                  l[u + 0],
                                  11,
                            ...
                            (v = s(
                              ...
                              (m = s(
                                m,
                                (p = s(p, _, v, m, l[u + 9], 4, 3654602809)),
                                _,
                                v,
                                l[u + 12],
                                11,
                          ...
                          (v = a(
                            ...
                            (m = a(
                              m,
                              (p = a(p, _, v, m, l[u + 0], 6, 4096336452)),
                              _,
                              v,
                              l[u + 7],
                              10,
                        ...
                        (v = a(
                          ...
                          (m = a(
                            m,
                            (p = a(p, _, v, m, l[u + 12], 6, 1700485571)),
                            _,
                            v,
                            l[u + 3],
                            10,
                      ...
                      (v = a(
                        ...
                        (m = a(
                          m,
                          (p = a(p, _, v, m, l[u + 8], 6, 1873313359)),
                          _,
                          v,
                          l[u + 15],
                          10,
                    ...
                    (v = a(
                      ...
                      (m = a(
                        m,
                        (p = a(p, _, v, m, l[u + 4], 6, 4149444226)),
                        _,
                        v,
                        l[u + 11],
                        10,
          ...
          (a.log = console.warn.bind(console)),
            (t.exports = (function () {
              function e(t) {
                ...
                if (-1 === n)
                  throw (
                    (a("invalid WebSocket URI: " + t),
                    new TypeError("Invalid argument: " + t))
                  );
                if ("wss" !== n.scheme && "ws" !== n.scheme)
                  throw (
                    (a("invalid WebSocket URI scheme: " + n.scheme),
                    new TypeError("Invalid argument: " + t))
                  );
                (this._sip_uri =
                  "sip:" +
                ...
                r(e, [
                  {
                    key: "connect",
                    value: function () {
                      if ((s("connect()"), this.isConnected()))
                        s("WebSocket " + this._url + " is already connected");
                      else if (this.isConnecting())
                        s("WebSocket " + this._url + " is connecting");
                      else {
                        this._ws && this.disconnect(),
                          s("connecting to WebSocket " + this._url);
                        try {
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      return (
                        ...
                        this.isConnected()
                          ? (this._ws.send(e), !0)
                          : (a("unable to send message, WebSocket is not open"),
                            !1)
                      );
                    },
                  },
                  ...
                  },
                  {
                    key: "_onOpen",
                    value: function () {
                      s("WebSocket " + this._url + " connected"),
                        this.onconnect();
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      var t = e.wasClean,
                        n = e.code,
                        r = e.reason;
                      s("WebSocket " + this._url + " closed"),
                        !1 === t && s("WebSocket abrupt disconnection");
          ...
          var r = e("./Constants"),
                ...
                try {
                  for (
                    ...
                    if (!c.hasHeader(s))
                      return (
                        a(
                          "missing mandatory header field : " +
                            s +
            ...
            l = [
              ...
              function () {
                if (
                  !c.to_tag &&
                  c.call_id.substr(0, 5) === d.configuration.jssip_id
                )
                  return f(482), !1;
              },
              function () {
          ...
          function r(e) {
            ...
            function r() {
              if (r.enabled) {
                ...
                for (
                  var a = new Array(arguments.length), o = 0;
                  o < a.length;
                  o++
                )
                  a[o] = arguments[o];
        ...
        function (e, t, n) {
          ...
          t.exports = function (e, t) {
            ...
            (c.prototype.onicecandidate = null),
              ...
              (c.prototype._createTransceiver = function (e) {
              ...
              (c.prototype.addTrack = function (t, n) {
                ...
                for (var r, i = 0; i < this.transceivers.length; i++)
                  ...
                  (this.transceivers[n].bufferedCandidateEvents = null),
                    ...
                    (s.onlocalcandidate = function (e) {
                      if (!(i.usingBundle && n > 0)) {
                        ...
                        var c = r.splitSections(i.localDescription.sdp);
                        (c[a.candidate.sdpMLineIndex + 1] += l
                          ? "a=end-of-candidates\r\n"
                          : "a=" + a.candidate.candidate + "\r\n"),
                          (i.localDescription.sdp = c.join(""));
              ...
              (c.prototype.setLocalDescription = function (e) {
                ...
                if (
                  !a("setLocalDescription", e.type, t.signalingState) ||
                  t._isClosed
                )
                  return Promise.reject(
                    l(
                ...
                if ("offer" === e.type)
                  ...
                  (n = r.splitSections(t.remoteDescription.sdp)),
                    (i = n.shift());
                    ...
                    if (
                      ...
                      o && (p.role = "server"),
                        (t.usingBundle && 0 !== n) ||
                          (t._gather(a.mid, n),
                          "new" === u.state &&
                            u.start(l, f, o ? "controlling" : "controlled"),
                ...
                return (
                  (t.localDescription = { type: e.type, sdp: e.sdp }),
                  "offer" === e.type
              ...
              (c.prototype.setRemoteDescription = function (i) {
                ...
                if (-1 === ["offer", "answer"].indexOf(i.type))
                  return Promise.reject(
                    l("TypeError", 'Unsupported type "' + i.type + '"')
                  );
                if (
                  !a("setRemoteDescription", i.type, s.signalingState) ||
                  s._isClosed
                )
                  return Promise.reject(
                    l(
                ...
                return (
                  ...
                  h.forEach(function (a, l) {
                    ...
                    if ("application" !== h || "DTLS/SCTP" !== m) {
                      ...
                      v ||
                        ((P = r.getIceParameters(a, f)),
                        ((O = r.getDtlsParameters(a, f)).role = "client")),
                        (w = r.parseRtpEncodingParameters(a));
                      var D = r.parseRtcpParameters(a),
                        N =
                          r.matchPrefix(a, "a=end-of-candidates", f).length > 0,
                        U = r
                      ...
                      if (
                        (("offer" === i.type || "answer" === i.type) &&
                          ...
                          l > 0 &&
                          s.transceivers[l] &&
                          (s._disposeIceAndDtlsTransports(l),
                          (s.transceivers[l].iceGatherer =
                            s.transceivers[0].iceGatherer),
                          (s.transceivers[l].iceTransport =
                            s.transceivers[0].iceTransport),
                          (s.transceivers[l].dtlsTransport =
                            s.transceivers[0].dtlsTransport),
                          s.transceivers[l].rtpSender &&
                            s.transceivers[l].rtpSender.setTransport(
                              s.transceivers[0].dtlsTransport
                            ),
                          s.transceivers[l].rtpReceiver &&
                            s.transceivers[l].rtpReceiver.setTransport(
                              s.transceivers[0].dtlsTransport
                            )),
                        "offer" !== i.type || v)
                      )
                        "answer" !== i.type ||
                          v ||
                          ((S = (C = s.transceivers[l]).iceGatherer),
                          (E = C.iceTransport),
                          (b = C.dtlsTransport),
                          (R = C.rtpReceiver),
                          (A = C.sendEncodingParameters),
                          (I = C.localCapabilities),
                          (s.transceivers[l].recvEncodingParameters = w),
                          (s.transceivers[l].remoteCapabilities = x),
                          (s.transceivers[l].rtcpParameters = D),
                          U.length &&
                            "new" === E.state &&
                            ((!p && !N) || (_ && 0 !== l)
                          ...
                          (_ && 0 !== l) ||
                            ("new" === E.state && E.start(S, P, "controlling"),
                            "new" === b.state && b.start(O)),
                          s._transceive(
                            C,
                          ...
                          !R || ("sendrecv" !== g && "sendonly" !== g)
                            ...
                            : ((k = R.track),
                              y
                                ? (c[y.stream] ||
                                    (c[y.stream] = new e.MediaStream()),
                                  n(k, c[y.stream]),
                                  d.push([k, R, c[y.stream]]))
                                : (c.default ||
                                    (c.default = new e.MediaStream()),
                                  n(k, c.default),
                                  d.push([k, R, c.default]))));
                      else {
                        ((C =
                          s.transceivers[l] || s._createTransceiver(h)).mid =
                          T),
                          C.iceGatherer ||
                            (C.iceGatherer = s._createIceGatherer(l, _)),
                          U.length &&
                        ...
                        if ("sendrecv" === g || "sendonly" === g) {
                          if (
                            ...
                            (R =
                              C.rtpReceiver ||
                              new e.RTCRtpReceiver(C.dtlsTransport, h)),
                            M)
                          ) {
                            var L;
                            (k = R.track),
                              (y && "-" === y.stream) ||
                                (y
                                  ? (c[y.stream] ||
                                      ((c[y.stream] = new e.MediaStream()),
                                      Object.defineProperty(c[y.stream], "id", {
                                        get: function () {
                                          return y.stream;
                                        },
                                      })),
                              ...
                              L &&
                                (n(k, L),
                                C.associatedRemoteMediaStreams.push(L)),
                              d.push([k, R, L]);
                          }
                        } else
                          C.rtpReceiver &&
                            C.rtpReceiver.track &&
                            (C.associatedRemoteMediaStreams.forEach(function (
                              t
                            ) {
                        ...
                        (C.localCapabilities = I),
                          ...
                          s._transceive(s.transceivers[l], !1, M);
                      }
                    } else s.transceivers[l] = { mid: T, isDatachannel: !0 };
                  }),
                  void 0 === s._dtlsRole &&
                    (s._dtlsRole = "offer" === i.type ? "active" : "passive"),
                  (s.remoteDescription = { type: i.type, sdp: i.sdp }),
                  "offer" === i.type
                  ...
                  Object.keys(c).forEach(function (t) {
                    ...
                    if (n.getTracks().length) {
                      if (-1 === s.remoteStreams.indexOf(n)) {
                        s.remoteStreams.push(n);
              ...
              (c.prototype.createOffer = function () {
                ...
                for (
                  ...
                  s > 0 && (n._createTransceiver("audio"), s--),
                    a > 0 && (n._createTransceiver("video"), a--);
                var u = r.writeSessionBoilerplate(
                  n._sdpSessionId,
                ...
                n.transceivers.forEach(function (i, s) {
                  var a = i.track,
                    o = i.kind,
                    l = i.mid || r.generateIdentifier();
                  (i.mid = l),
                    i.iceGatherer ||
                      (i.iceGatherer = n._createIceGatherer(s, n.usingBundle));
                  ...
                  var c = i.sendEncodingParameters || [
                    { ssrc: 1001 * (2 * s + 1) },
                  ];
                  a &&
                    t >= 15019 &&
                    ...
                    (u += i(
                      ...
                      !e.iceGatherer ||
                        ...
                        (e.iceGatherer
                          ...
                          .forEach(function (e) {
                            (e.component = 1),
                              (u += "a=" + r.writeCandidate(e) + "\r\n");
                          }),
                        "completed" === e.iceGatherer.state &&
                          (u += "a=end-of-candidates\r\n"));
                  });
                var c = new e.RTCSessionDescription({ type: "offer", sdp: u });
                ...
                n.usingBundle &&
                  (a +=
                    ...
                    n.transceivers
                      ...
                      .join(" ") +
                    "\r\n");
                var o = r.splitSections(n.remoteDescription.sdp).length - 1;
                ...
                return e && void 0 === e.sdpMLineIndex && !e.sdpMid
                  ...
                  : new Promise(function (i, s) {
                      ...
                      if (e && "" !== e.candidate) {
                        ...
                        var c = n.transceivers[a];
                        if (!c)
                          return s(
                            l("OperationError", "Can not add ICE candidate")
                          );
                        if (c.isDatachannel) return i();
                        var d =
                        ...
                        0 === h.indexOf("a=") && (h = h.substr(2)),
                          ((t = r.splitSections(n.remoteDescription.sdp))[
                            a + 1
                          ] +=
                            "a=" + (d.type ? h : "end-of-candidates") + "\r\n"),
                          (n.remoteDescription.sdp = t.join(""));
                      } else for (var f = 0; f < n.transceivers.length && (n.transceivers[f].isDatachannel || (n.transceivers[f].iceTransport.addRemoteCandidate({}), ((t = r.splitSections(n.remoteDescription.sdp))[f + 1] += "a=end-of-candidates\r\n"), (n.remoteDescription.sdp = t.join("")), !n.usingBundle)); f++);
                      i();
                    });
              }),
      ...
      41: [
        function (e, t, n) {
          ...
          t.exports = function (t, n) {
            ...
            switch (l.browser) {
              case "chrome":
                if (!c || !c.shimPeerConnection || !s.shimChrome)
                  return (
                    o("Chrome shim is not included in this adapter release."), u
                  );
                ...
                break;
              case "firefox":
                if (!h || !h.shimPeerConnection || !s.shimFirefox)
                  return (
                    o("Firefox shim is not included in this adapter release."),
                    u
                  );
                ...
                break;
              case "edge":
                if (!d || !d.shimPeerConnection || !s.shimEdge)
                  return (
                    o("MS edge shim is not included in this adapter release."),
                    u
                  );
                o("adapter.js shimming edge."),
                  ...
                  d.shimReplaceTrack(i);
                break;
              case "safari":
                if (!f || !s.shimSafari)
                  return (
                    o("Safari shim is not included in this adapter release."), u
                  );
                  ...
                  Object.keys(t._streams).forEach(function (r) {
                    ...
                    n &&
                      (1 === n.getTracks().length
                        ? t.removeStream(t._reverseStreams[n.id])
                ...
                e.HTMLMediaElement.prototype.setAttribute = function () {
                  return (
                    2 === arguments.length &&
                      ...
                      (this.srcObject = s.get(arguments[1]) || null),
          ...
          t.exports = function (e) {
            ...
            n.getUserMedia = function (e, i, s) {
              ...
              r.deprecated(
                ...
                n.mediaDevices.getUserMedia(e).then(i, s);
            };
          };
        },
        { "../utils": 50 },
                  ...
                  (e.RTCPeerConnection.prototype.addStream = function (e) {
                    ...
                    (e.RTCPeerConnection.prototype.addTrack = function (e, n) {
                      return (
                        n &&
                          (this._localStreams
                            ? -1 === this._localStreams.indexOf(n) &&
          ...
          t.exports = {
            ...
            detectBrowser: function (e) {
              ...
              if (t.mozGetUserMedia)
                (n.browser = "firefox"),
                  (n.version = s(t.userAgent, /Firefox\/(\d+)\./, 1));
              else if (t.webkitGetUserMedia)
                if (e.webkitRTCPeerConnection)
                  (n.browser = "chrome"),
                    (n.version = s(t.userAgent, /Chrom(e|ium)\/(\d+)\./, 2));
                else {
                  ...
                  (n.browser = "safari"),
                    (n.version = s(t.userAgent, /AppleWebKit\/(\d+)\./, 1));
                }
              else if (
                t.mediaDevices &&
                ...
                (n.browser = "edge"),
                  (n.version = s(t.userAgent, /Edge\/(\d+).(\d+)$/, 2));
              else {
                if (
                  !t.mediaDevices ||
